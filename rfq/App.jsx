      ...
      <div className="main-content">
        ...
        <div className="feed">
          ...
          <div
            ...
            onMouseEnter={() => setExpandedFilter(true)}
            onMouseLeave={() => setExpandedFilter(false)}
          >
            ...
            <div className="view-buttons">
              <Button
                icon={visibility === 'public' ? 'pi pi-globe' : 'pi pi-lock'}
                className={`p-button-text ${visibility === 'public' ? 'active' : ''}`}
                tooltip={visibility === 'public' ? 'Public Posts' : 'Private Posts'}
